                ...
                <fieldset>
                    <div class='div-form'>
                        <div class='div-form-1'>
                            ...
                            <input type='text' name='cpf' id='cpf' value='<?php echo $funcionario_dados->getCpf();?>' readonly='readonly'></input>

                            <label for="nome">Nome:<span>*</span> </label>
                            <input type='text' name='nome' id='nome' value='<?php echo $funcionario_dados->getNome();?>' readonly='readonly'></input>  
                            ...
                            <input type='text' name='usuario' id='usuario' value='<?php echo $funcionario_dados->getUsuario();?>' readonly='readonly'></input>
                        
                            <label for="senha">Senha:<span>*</span> </label>
                            <input type='text' name='senha' id='senha' value='<?php echo $funcionario_dados->getSenha();?>' readonly='readonly'></input> 
