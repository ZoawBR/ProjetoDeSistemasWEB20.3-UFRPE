                ...
                <fieldset>
                    <div class='div-form'>
                        <div class='div-form-1'>
                            ...
                            <input type='text' name='cpf' id='cpf' value='<?php echo $funcionario_dados->getCpf();?>'></input>

                            <label for="nome">Nome:<span>*</span> </label>
                            <input type='text' name='nome' id='nome' value='<?php echo $funcionario_dados->getNome();?>'></input>  
                            ...
                            <input type='text' name='usuario' id='usuario' value='<?php echo $funcionario_dados->getUsuario();?>'></input>
                        
                            <label for="senha">Senha:<span>*</span> </label>
                            <input type='password' name='senha' id='senha' value='<?php echo $funcionario_dados->getSenha();?>' ></input> 
